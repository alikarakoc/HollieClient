...
export class BoardService{
    ...
    deleteBoard(board:Partial<Board>){
        return this.http.delete<ListResponseModel<Board>>(`${this.baseUrl}/delete?Id=${board.id}`);
    }

    updateBoard(board:Partial<Board>){
        return this.http.put<ListResponseModel<Board>>(`${this.baseUrl}/update?Id=${board.id}`, board)
    }
