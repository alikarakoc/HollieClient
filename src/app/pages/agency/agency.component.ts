...
import { AgencyAddDialogComponent, AgencyDeleteDialogComponent, AgencyUpdateDialogComponent } from "src/app/components";
...
export class AgencyComponent implements OnInit {
  ...
  constructor(public agencyService: AgencyService, private dialog: MatDialog) { }
